...
[**a**](#a-contrario) - [**b**](#baader-meinhof-phenomenon) - [**c**](#cabal) - [**d**](#dactyl) - [**e**](#e-pluribus-unum) - [**f**](#fabulist) - [**g**](#gaffe) - [**h**](#hajj) - [**i**](#iatrogenic) - [**j**](#jape) - [**k**](#kabuki-theatre) - [**l**](#labile) - [**m**](#macedoine) - [**n**](#nabob) - [**o**](#obdurate) - [**p**](#padnag) - [**q**](#quagmire) - [**r**](#raconteur) - [**s**](#sage) - [**t**](#taciturn) - [**u**](#ubiety) - [**v**](#vacuous) - [**w**](#wallah-wallah) - [**x**](#xanadu) - [**y**](#yahoo) - [**z**](#zaftig) - [**é**](#énouement)
### a contrario
...
### absolution
A release from guilt, sin or sentence.


### abstemious
Taking food and drink in moderation; temperance.
...
### acolyte
An attendant, assistant or novice. A follower.
...
### agent provocateur
French: a political spy who provokes people to perform an illegal action that
...
### anachronism
A person or event erroneously placed in time.
...
### anomaly
An unexpected result that deviates from the standard.


### anomie
The breakdown of norms, ethics and values in a person or in society.


### anosmia
Smell blindness; the loss of the ability to detect one or more smells.
...
### antepenultimate
The third from the last in a series.
...
### arrogate
To claim for oneself without justification.
...
### autodidact
A person who teaches himself a subject.
...
### avocado
Aztec: The original meaning is "testicle".
...
### bailiwick
In one's area of interest or authority.


### baleful
Extremely harmful; pernicious.


### balletomane
A ballet-lover, who for some reason is not called a balletophile.
...
### eleemosynary
Charitable or supported by a charity.
...
### embrangle
Embroil and entangle.


### emeritus
No longer actively employed, but kept on the staff as an honor. a person retired
...
### emolument
The pay or profit from employment, or more likely, from a political office.
...
### emulsion
A mixture of two or more liquids that are normally immiscible owing to liquid-
liquid phase separation. Emulsions are part of a more general class of two-phase
...
### enigma
A puzzling matter that cannot be easily explained.


### ennui
Indifferent; bored in a world-weary sense.
...
### epicene
Reflecting both male and female characteristics; androgynous.
...
realization of the true meaning of something.
...
### equivocal
Having several meanings and therefore capable of being interpreted in several
ways.
...
### faux pas
From the French for "false step." A social blunder, an error of etiquette.


### feral
Animalistic; existing in a wild state.
...
### flaneur
A word that comes from the French and means "idler" or "loafer".
...
### flotsam
The floating remains of a sunken or wrecked ship. Jetsam is the floating stuff
purposely thrown overboard to keep a ship from sinking in the first place.
...
### flubdub
A ridiculous, poorly-thought-out, bombastic argument.


### flump
To drop with a heavy thud.


### foozle
To bungle or goof up.
...
### fractious
Irritable, whiny, quarrelsome and rebellious.


### friable
Describes the tendency of a solid substance to break into smaller pieces under
duress or contact, especially by rubbing.


### frisson
A shiver, as from a thrill or a fright.
...
### halidom
A holy place, thing, or sanctuary, such as a chapel or church.


### handsel
A gift or present that is meant to bring good luck.
...
### harbinger
A person, thing or event that foreshadows the arrival of something.


### harridan
A bad-tempered old woman; a hag.
...
### hydronym
The proper name of a body of water. A type of toponym.
...
### lubricous
Marked by wantonness; letcherous.
...
### maladroit
Physically awkward or clumsy, as well as verbally awkward in the sense of
tactless.
...
### manque
Unfulfilled, or might-have-been.
...
### maverick
A nonconformist or a rebel, a person whose thoughts and actions are different
from most others.
...
### meet
Something that is meet is fitting, suitable or appropriate.


### megrims
A depression or sinking into low spirits.


### melange
This French word for "mixture".
...
### mellifluous
Music or sound that flows smoothly or sweetly.
...
characteristics of being and of things that exist. LOGIC: A logical system
involving theory of classes. COMPUTER SCIENCE: A structure of concepts or
...
### proscribe
To forbid something or label something dangerous.


### proselytize
Trying to convert others by using strongly persuasive language or convincing
argument. It implies a certain degree of oppressive lecturing.
...
### Proustian
Any sensory experience that provokes a flood of nostalgia.


### provenance
Place of origin or source.
...
### pulchritude
Absolutely beautiful. A person of breathtaking, heartbreaking beauty is
pulchritudinous.
...
### putsch
A sudden uprising and takeover.
...
is probably more often used figuratively to mean a murky mess.


### quash
Verb meaning "to put an end to" or "to get rid of."


### quasi
Seeming to be, but not really being.
...
### quid pro quo
Tit for tat; something given in return.
...
### quixotic
Someone who is romantic and idealistic and pursues lofty but impractical goals.
...
### recreant
A traitor or a coward, someone who abandons his friends, family or country.
...
### rectitude
Moral righteousness or integrity.
...
that arrogant pedant's rodomontade.
...
### rosy retrospection
Remembering experiences more favorably than they were experienced.
...
### sage
A spice, also meaning "extremely wise".
...
### spoor
One of those words you hear often but are never quite sure what it means —
a track or trail of bones, dung, or fur made by a person or an animal being
hunted.
...
### succubus
A female demon which comes to men in their dreams to seduce them and have sexual
intercourse, drawing energy from the men to sustain themselves, often until the
...
### tendentious
Having a particular tendency; leaning; lacking impartiality.  written or spoken
with a partisan, biased or prejudiced purpose, especially a controversial one.
...
### thalassic
Of or relating to seas and oceans or smaller bodies of water.
...
purpose. Distinguish from messianic, which can have less heavenly associations.
...
### trompe l'oeil
A painting intended to create an illusion.
...
### ubiety
Presence, or the state of being there.
